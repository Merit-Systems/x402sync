...
function buildQuery(
  ...
  // Build the signer condition for multiple facilitators
  const signerPubkey = facilitators[0]; // For simplicity, handle one at a time
...
export const solanaBigQueryConfig: ChainSyncConfig = {
  ...
  apiUrl: "", // TODO: Add BigQuery API URL
  facilitators: [
